...
Simulation *makeSim(std::string exampleName, bool runBackward = true) {
  ...
  if (exampleName == "wear_hat") {
    ...
    // create simulation instance
    Simulation::SceneConfiguration initSceneProfile =
        OptimizationTaskConfigurations::sockScene;
    sim =
        Simulation::createSystem(initSceneProfile, Vec3d(0, 0, 0), runBackward);
    // define loss
    ...
    Vec3d calfPoint = leg.getTransformedPosFromJointBindPos(
        Vec3d(0, sim->sockLeg.leg->length * 0.4, -leg.radius));
    ...
    // Vec3d toePoint = foot.getTransformedPosFromJointBindPos(Vec3d(0, 0,
    // foot.radius));
    ...
    // std::cerr << "radius = " << foot.radius << ", " << leg.radius <<
    // std::endl;
...
OptimizeHelper *makeOptimizeHelperWithSim(std::string exampleName,
                                          Simulation *sim) {
  Simulation::forwardConvergenceThreshold = 1e-5;
...
void render(Simulation *sim, bool renderPosPairs = false,
            bool autoExit = true) {
  RenderLoop::renderRecordsForSystem(sim, sim->forwardRecords, renderPosPairs,
                                     autoExit, "visualization");
}
...
PYBIND11_MODULE(diffcloth_py, m) {
  ...
  py::class_<Simulation::SceneConfiguration>(m, "SceneConfiguration")
      ...
      .def_readwrite(
          ...
          &Simulation::SceneConfiguration::customAttachmentVertexIdx);

  // Simulation::PrimitiveCollisionInformation
  py::class_<Simulation::PrimitiveCollisionInformation>(
      m, "PrimitiveCollisionInformation")
      .def_readonly("primitiveId",
                    &Simulation::PrimitiveCollisionInformation::primitiveId)
      .def_readonly("particleId",
                    &Simulation::PrimitiveCollisionInformation::particleId);

  // Simulation::SelfCollisionInformation
  py::class_<Simulation::SelfCollisionInformation>(m,
                                                   "SelfCollisionInformation")
      .def_readonly("particleId1",
                    &Simulation::SelfCollisionInformation::particleId1)
      .def_readonly("particleId2",
                    &Simulation::SelfCollisionInformation::particleId2);
  ...
  py::class_<Simulation::ForwardInformation>(m, "ForwardInformation")
      ...
      .def_readonly("x_fixedpoints",
                    &Simulation::ForwardInformation::x_fixedpoints)
      .def_readonly("avgDeformation",
                    &Simulation::ForwardInformation::avgDeformation)
      .def_readonly("maxDeformation",
                    &Simulation::ForwardInformation::maxDeformation)
      .def_readonly("collisionInfos",
                    &Simulation::ForwardInformation::collisionInfos);
  ...
  py::class_<Simulation::BackwardInformation>(m, "BackwardInformation")
      ...
      .def_readonly("dL_ddensity",
                    &Simulation::BackwardInformation::dL_ddensity)
      .def_readonly("dL_dk_pertype",
                    &Simulation::BackwardInformation::dL_dk_pertype)
      .def_readonly("dL_dsplines",
                    &Simulation::BackwardInformation::dL_dsplines)
      .def_readonly("dL_dmu", &Simulation::BackwardInformation::dL_dmu)
      .def_readonly("loss", &Simulation::BackwardInformation::loss)
      .def_readonly("totalRuntime",
                    &Simulation::BackwardInformation::totalRuntime)
      .def_readonly("converged", &Simulation::BackwardInformation::converged)
      .def_readonly("convergedAccum",
                    &Simulation::BackwardInformation::convergedAccum)
      .def_readonly("backwardIters",
                    &Simulation::BackwardInformation::backwardIters)
      .def_readonly("backwardTotalIters",
                    &Simulation::BackwardInformation::backwardTotalIters);

  // Simulation::BackwardTaskInformation
  py::class_<Simulation::BackwardTaskInformation>(m, "BackwardTaskInformation")
      .def_readonly("dL_dk_pertype",
                    &Simulation::BackwardTaskInformation::dL_dk_pertype)
      .def_readonly("dL_density",
                    &Simulation::BackwardTaskInformation::dL_density)
      .def_readonly("dL_dfext", &Simulation::BackwardTaskInformation::dL_dfext)
      .def_readonly("dL_dfwind",
                    &Simulation::BackwardTaskInformation::dL_dfwind)
      .def_readonly("adddr_dd", &Simulation::BackwardTaskInformation::adddr_dd)
      .def_readonly("dL_dcontrolPoints",
                    &Simulation::BackwardTaskInformation::dL_dcontrolPoints)
      ...
      .def_readonly("dL_dwindFactor",
                    &Simulation::BackwardTaskInformation::dL_dwindFactor)
      .def_readonly("forwardAccuracyLevel",
                    &Simulation::BackwardTaskInformation::forwardAccuracyLevel)
      .def_readonly("backwardAccuracyLevel",
                    &Simulation::BackwardTaskInformation::backwardAccuracyLevel)
      .def_readonly("randSeed", &Simulation::BackwardTaskInformation::randSeed)
      .def_readonly("srandSeed",
                    &Simulation::BackwardTaskInformation::srandSeed);

  // Simulation::CorresPondenceTargetInfo
  py::class_<Simulation::CorresPondenceTargetInfo>(m,
                                                   "CorresPondenceTargetInfo")
      .def_readonly("frameIdx", &Simulation::CorresPondenceTargetInfo::frameIdx)
      .def_readonly("targetPos",
                    &Simulation::CorresPondenceTargetInfo::targetPos)
      .def_readonly("particleIndices",
                    &Simulation::CorresPondenceTargetInfo::particleIndices);

  // Simulation::LossInfo
  py::class_<Simulation::LossInfo>(m, "LossInfo")
      .def_readwrite("targetLoc", &Simulation::LossInfo::targetLoc)
      .def_readwrite("targetTranslation",
                     &Simulation::LossInfo::targetTranslation)
      .def_readwrite("targetFrameShape",
                     &Simulation::LossInfo::targetFrameShape)
  ...
  primitive.def_readwrite("primitives", &Primitive::primitives)
      ...
      .def_readonly_static("primitiveTypeStrings",
                           &Primitive::primitiveTypeStrings)
      .def("getMesh", &Primitive::getMesh, "getMesh", py::arg("cumulativeMesh"),
           py::arg("cumulativePos"), py::arg("center"), py::arg("frameIdx"))
  ...
  py::class_<Simulation>(m, "Simulation")
      ...
      .def_readwrite("useCustomRLFixedPoint",
                     &Simulation::useCustomRLFixedPoint)
      .def_readwrite("perStepGradient", &Simulation::perStepGradient)
      .def_readwrite("gradientClipping", &Simulation::gradientClipping)
      .def_readwrite("gradientClippingThreshold",
                     &Simulation::gradientClippingThreshold)
      .def_property_readonly("ndof_u", &Simulation::getActionDim)
      .def_property_readonly("num_particles", &Simulation::getNumParticles)
      .def_readwrite_static("forwardConvergenceThreshold",
                            &Simulation::forwardConvergenceThreshold)
      .def_readwrite_static("backwardConvergenceThreshold",
                            &Simulation::backwardConvergenceThreshold)
      .def("resetSystem",
           static_cast<void (Simulation::*)()>(&Simulation::resetSystem),
           "reset the simulation")
      .def("step", &Simulation::step, "forward one step")
      .def("getCurrentPosVelocityVec", &Simulation::getCurrentPosVelocityVec,
           "get posvel vecs")
      .def("appendPerStepGradient", &Simulation::appendPerStepGradient,
           "append grad", py::arg("x"))
      .def("stepNN", &Simulation::stepNN, "forward one step with arg",
           py::arg("idx"), py::arg("x"), py::arg("v"), py::arg("fixedPointPos"))
      .def("setWindAndCollision", &Simulation::setWindAncCollision,
           "setWindAndCollision", py::arg("windEnable"),
           py::arg("collisionEnable"), py::arg("selfCollisionEnable"),
           py::arg("enableConstantForcefield"))
      ...
      .def("exportCurrentMeshPos", &Simulation::exportCurrentMeshPos,
           "export the mesh at certain step", py::arg("step"),
           py::arg("filename"))
      .def("setPrintVerbose", &Simulation::setPrintVerbose,
           "set whether to print verbose info", py::arg("flag"))
      ...
      .def("exportCurrentSimulation", &Simulation::exportCurrentSimulation,
           "export the simulation to files", py::arg("fileName"))
      .def("stepBackward", &Simulation::stepBackward, "stepbackward one step",
           py::arg("taskInfo"), py::arg("dL_dxvfnew"),
           py::arg("forwardInfo_new"), py::arg("isStart"), py::arg("dL_dxinit"),
           py::arg("dL_dvinit"))
      .def("stepBackwardNN", &Simulation::stepBackwardNN,
           "stepbackward one step", py::arg("taskInfo"), py::arg("dL_dxnew"),
           py::arg("dL_dvnew"), py::arg("forwardInfo_new"), py::arg("isStart"),
  ...
  py::class_<OptimizeHelper>(m, "OptimizeHelper")
      ...
      .def_readonly("paramLogScaleTransformOn",
                    &OptimizeHelper::paramLogScaleTransformOn)
      ...
      .def("getRandomParam", &OptimizeHelper::getRandomParam,
           "generate random initial parameters", py::arg("randSeed") = 0)
      .def("runSimulationAndGetLoss", &OptimizeHelper::runSimulationAndGetLoss,
           "compute loss from parameter vector", py::arg("x"))
      .def("vecXdToParamInfo", &OptimizeHelper::vecXdToParamInfo,
           "compute loss from parameter vector", py::arg("x"))
      .def("gradientInfoToVecXd", &OptimizeHelper::gradientInfoToVecXd,
           "convert grad struct to grad vector", py::arg("grad"))
      .def("runSimulationAndGetLossGradient",
           &OptimizeHelper::runSimulationAndGetLossAndGradients,
  ...
  m.def("enableOpenMP", &enableOpenMP, "set up Open MP",
        py::arg("n_threads") = 5);

  m.def("render", &render, "rendering the previous trajectry", py::arg("sim"),
        py::arg("renderPosPairs") = false, py::arg("autoExit") = true);
}
